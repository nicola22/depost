<!-- Impressum wird erstelt-->
<main>
    <h1 class = "ueberschrift">impressum</h1>
    <div class="impressum">
        <h2>Kontaktadresse</h2>
        <p>Depost</p>
        <p>Jamie&nbsp;Hoog</p><p>Nicola&nbsp;Luethi</p>
        <p>Engehaldestrasse 26</p>
        <p>3030 Bern</p>
        <p>Schweiz</p>
        <p><a href="mailto:jamie.hoog@ict-campus.net">jamie.hoog@ict-campus.net</a> </p><p><a href="mailto:nicola.luethi@ict-campus.net">nicola.luethi@ict-campus.net</a></p>
        <p>&nbsp;</p>
        ...
        <p>&nbsp;</p>
        <h2>Urheberrechte</h2>
        <p>Die Urheber- und alle anderen Rechte an Inhalten, Bildern, Fotos oder anderen Dateien auf der Website gehören ausschliesslich <strong>der Firma Depost</strong> oder den speziell genannten  Rechtsinhabern. Für die Reproduktion jeglicher Elemente ist die schriftliche Zustimmung der Urheberrechtsträger im Voraus einzuholen.</p>
        <p>&nbsp;</p>
        <h2>Datenschutz</h2>
        ...
        <p>&nbsp;</p>
        <h2>Quelle</h2>
        <p> Dieses Impressum wurde am <strong>22.03.2019</strong> mit dem  Impressum-Generator <strong><a href="http://www.bag.ch/impressum-generator">http://www.bag.ch/impressum-generator</a></strong> der Firma Brunner Medien AG in Kriens erstellt. Die Brunner Medien AG in Kriens übernimmt keine  Haftung. </p>
